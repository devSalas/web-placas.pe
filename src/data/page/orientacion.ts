...
export const orientacion= {
   ...
   content:[
    ...
    {
        name:"Solicitud",
        description:"Ingrese al sistema y registre una solicitud de trámite de placas (Solicitud de placa regular, especial, MRE, entre otras)."
    },
    {
        name:"Forma de Pago",
        description:"El pago se efectua después de realizado la solicitud. El sistema le brindará un código único que lo acreditará al momento del pago en ventanilla del banco"
    },
    {
